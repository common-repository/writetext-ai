...
?>
<div class="wtai-wp-filter wtai-filter-main-wrap wtai-category-filter-main-wrap">
						...
						<div class="wtai-tone-and-styles-select wtai-audiences-form-select">
							...
							<div class="wtai-tooltip">
								...
								<div class="wtai-tooltiptext">
									...
									<?php
									// TODO: Update PO files.
									echo wp_kses_post( __( 'Select the applicable audience for your category so WriteText.ai can generate text that will appeal to them.  If you don’t select an audience, the generated text will default to a “neutral” audience. WriteText.ai also suggests more specific audiences based on your target keywords. Click on the audience to select it or type in your own custom audience in the box.', 'writetext-ai' ) );
									?>
								</p>
							</div>
						</div>
...
<div class="wtai-filter-main-actions" >
	<div class="wtai-collapse-expand-wrapper" >
		<ul class="subsubsub wtai-flex-item">
			<li class="wtai-filter-cb-publish"><label for="wtai-checkboxes-all"><input type="checkbox" id="wtai-checkboxes-all" class="wtai-checkboxes-all disabled wtai-init-fields" disabled /> <a href="#" class="wtai-select-all-checkbox  disabled wtai-init-fields"><?php echo wp_kses_post( __( 'Select all', 'writetext-ai' ) ); ?> </a> |</label></li>
			<li class="wtai-filter-cb-byorder"><a href="#"  class="wtai-select-all-checkbox-expand"><?php echo wp_kses_post( __( 'Collapse', 'writetext-ai' ) ); ?>/<?php echo wp_kses_post( __( 'Expand all', 'writetext-ai' ) ); ?></a></li>
		</ul>
	</div>
	...
	<div class="wtai-generate-wrapper wtai-postbox-process-wrapper wtai-flex-item">
		...
		<div class="wtai-generate-cta-radio-wrap" >
			<div class="wtai-step-6-container-wrap" >
		...
		<div class="wtai-generate-cta-wrap" >
			...
			<div class="wtai-tooltip wtai-d-flex wtai-generate-tooltip">
				...
				<div class="wtai-tooltiptext">
					...
					<p>' . wp_kses_post( __( 'If any of your settings (e.g., representative products, keywords, tone, style, and audiences) have changed but you don’t necessarily want to generate completely new text, you can use the Rewrite feature to keep the existing structure of the text but rewrite it to reflect any changes.', 'writetext-ai' ) ) . '</p>
